...
resource "aws_organizations_account" "workloads_prod" {
  ...
  email     = var.full_email.prod != "" ? var.full_email.prod : "${var.email_local_part}_${lower(replace(var.org_accounts.workloads.prod[count.index], " ", ""))}@${var.email_domain}"
...
resource "aws_organizations_account" "workloads_staging" {
  ...
  email     = var.full_email.staging != "" ? var.full_email.staging : "${var.email_local_part}_${lower(replace(var.org_accounts.workloads.staging[count.index], " ", ""))}@${var.email_domain}"
...
resource "aws_organizations_account" "workloads_dev" {
  ...
  email     = var.full_email.dev != "" ? var.full_email.dev : "${var.email_local_part}_${lower(replace(var.org_accounts.workloads.dev[count.index], " ", ""))}@${var.email_domain}"
...
resource "aws_organizations_account" "workloads_uat" {
  ...
  email     = var.full_email.uat != "" ? var.full_email.uat : "${var.email_local_part}_${lower(replace(var.org_accounts.workloads.uat[count.index], " ", ""))}@${var.email_domain}"
...
resource "aws_organizations_account" "common_services" {
  ...
  email     = "${var.email_local_part}_${lower(replace(var.org_accounts.common_services[count.index], " ", ""))}@${var.email_domain}"
  parent_id = aws_organizations_organizational_unit.common_services.id
